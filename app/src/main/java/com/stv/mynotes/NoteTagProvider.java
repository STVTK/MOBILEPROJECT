...
//                DBOpenHelper.NOTE_TAG_CREATED + " DESC");
        return database.query(true, DBOpenHelper.TABLE_NOTE_TAG,DBOpenHelper.NOTE_TAG_ALL_COLUMNS,selection,
                null,null,null,DBOpenHelper.NOTE_TAG_CREATED + " DESC",null);
    }
